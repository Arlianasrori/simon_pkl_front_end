    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          axios
            .post("http://localhost:2008/siswa/absen-jadwal/cek", location, {
              withCredentials: true
            })
            .then((response) => {
              axios.post("http://localhost:2008/siswa/absen/absen-keluar", formData,{
                headers:{
                ...
                .then((res) => {
                  ...
                  console.log(err);
                  toast.error(err.response.data.msg.toUpperCase());
                })
